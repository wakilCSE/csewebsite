                                                ...
                                                <div class="col-sm-6 col-md-3 ">
                                                    <div class="thumbnail div-mem">
                                                        <div class="profile-pic div-height">
                                                            <img src="{{$item->image }}" style="height: 300px; width:280px">
                                                        </div>

                                                        <div class="caption">
                                                            <p class="text-center soc-icon">
                                                                <div>
                                                                <span style="color:#121111; font-size:16px">{{ $item->name }}
                                                                    </span>
                                                                <br>
                                                                <b><i>{{ $item->designation }}</i></b>
                                                                <br>

                                                                <b><i> {{ $item->dept }}</i></b>
                                                                <br>
                                                                <b>Email: </b>{{ $item->email }}<br>
                                                                <b>Mobile No: </b>{{ $item->mobile }} <br>
                                                                <br>
                                                                </div>
                                                                <a target="_blank" class="btn btn-primary"
                                                                    role="button" href="">View Profile <i
