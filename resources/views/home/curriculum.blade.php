...
Programming Fundamentals (e.g., Python, Java, or C++) <br>
Mathematics for Computer Science (e.g., Discrete Mathematics, Linear Algebra, Calculus) <br>
...
Data Structures and Algorithms (Advanced) <br>
Database Management Systems <br>
Operating Systems <br>
Computer Networks <br>
Web Development (HTML, CSS, JavaScript) <br>
Software Development Methodologies (e.g., Agile, Scrum) <br>
Ethics and Professionalism in Computing <br>
