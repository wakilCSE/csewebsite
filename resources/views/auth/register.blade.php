<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
         ...
         <!-- session -->
         <div class="mt-4">
            <x-input-label for="sess_ion" :value="__('Sess_ion')" />
            <x-text-input id="sess_ion" class="block mt-1 w-full" type="text" name="sess_ion" :value="old('sess_ion')" required autocomplete="username" />
            <x-input-error :messages="$errors->get('sess_ion')" class="mt-2" />
        </div>
